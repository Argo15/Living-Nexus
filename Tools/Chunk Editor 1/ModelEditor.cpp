...
{
	ArgoObject *object = new ArgoObject(new QString(*currentModel+QString(" Actor")),currentModel,currentMat);
	float *center = ArgoModelManager::Instance()->getModel(*currentModel)->getCenter();
	object->Translate(center[0],center[1],center[2]);
