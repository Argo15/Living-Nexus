...
void ArgoMaterialManager::LoadMaterial(const char *filename)
{
	ArgoMaterial *newMaterial = new ArgoMaterial(new QString("Loaded Material"));
	newMaterial->loadMaterial(filename);
