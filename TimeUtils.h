...
namespace Time {
	...
	static std::string SKY_NEAR_SUN_COLORS[] = {
		ConfigNames::MORNING_SKY_NEAR_SUN_COLOR,
		ConfigNames::DAY_SKY_NEAR_SUN_COLOR,
		ConfigNames::EVENING_SKY_NEAR_SUN_COLOR,
		ConfigNames::NIGHT_SKY_NEAR_SUN_COLOR
	};

	static std::string SKY_AWAY_SUN_COLORS[] = {
		ConfigNames::MORNING_SKY_AWAY_SUN_COLOR,
		ConfigNames::DAY_SKY_AWAY_SUN_COLOR,
		ConfigNames::EVENING_SKY_AWAY_SUN_COLOR,
		ConfigNames::NIGHT_SKY_AWAY_SUN_COLOR
	};

	static std::string CLOUD_COLORS[] = {
		ConfigNames::MORNING_CLOUD_COLOR,
		ConfigNames::DAY_CLOUD_COLOR,
		ConfigNames::EVENING_CLOUD_COLOR,
		ConfigNames::NIGHT_CLOUD_COLOR
	};
